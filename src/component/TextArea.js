...
class TextArea extends Component {
   ...
   this.inputText ="";
    ...
    //  submitCode = () =>{
    //     //  input text di daapat dari parameter kosong di atas
    //     const fn = new Function(this.inputText)
    //     const resultFn = fn();
    //     // code : berasal dri paaramter di ats di dalam constuctor
    //     // dan code di replace dengan resultfn yang berisikan fn
